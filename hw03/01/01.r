...
print(mean_t*mean_t)
# 0.0004 - expected
# 0.0004121522 - no frag
# 0.000406769 - fragmentation
print(var_t)
...
lines(xGrid, dexp(xGrid, rate=L_t), col='red', lw=2, lty=1)
...
print(mean_s)
# 331776 - expected
# 334085.2 - no fragmentation
# 233101.3 - fragmentation
print(var_s)
...
lines(xGrid, dexp(xGrid, rate=L_s), col='red', lw=2, lty=1)
